...
public class MethodOverLoading3 { //one class one object
	...
	void display() { //its not method overloading
		System.out.println("I am Pune"); //where having void there must have syso statment callig main method via object.methodname
	}
	int addNumbers() {
