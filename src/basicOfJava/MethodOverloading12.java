...
public class MethodOverloading12 {
	...
	static public void square(double number) { // we can set float me double like widening casting
		res = number * number;
		System.out.println("Method with float Argument Called:" + res);
	}
	public static void main(String[] args) {
		System.out.println("Result: "+res);//
		MethodOverloading12.square(2.5f);
		System.out.println("Result: "+res);//
		MethodOverloading12.square();
		MethodOverloading12.square(5);
		System.out.println("Result: "+res);//
	}
}
