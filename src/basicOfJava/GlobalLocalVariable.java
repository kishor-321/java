...
public class GlobalLocalVariable {
	...
	public static void main(String[] args) {
		...
		GlobalLocalVariable ref1=new GlobalLocalVariable();
		System.out.println(ref1.salary);
		
		
		//static-members: empID,age, callA(),callC(int acc)
		System.out.println(GlobalLocalVariable.age);//35
		System.out.println(GlobalLocalVariable.empID);//0
		GlobalLocalVariable.callA();//can't write this inside println as it won't return any value
		//way-1:
		GlobalLocalVariable.callC(12345);//it will execute method but you won't be able to use/see its return value
		//way-2:
		System.out.println(GlobalLocalVariable.callC(12345));//it will execute method and you see the return value in the console
		//way-3
		int value=GlobalLocalVariable.callC(12345);//it will execute method and storing return value in variable for future use
