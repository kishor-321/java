...
public class MethodOverloading5 {
	...
	public static void main(String[] args) {
		...
		System.out.println("sum:2 "+MethodOverloading5.addNumbers(45, 55));
		System.out.println("sum:3 "+addNumbers(47, 53,58));//
		System.out.println("sum:4 "+MethodOverloading5.addNumbers(47, 53.56,58)); //standard way for caliing method via classname
	}
