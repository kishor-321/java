...
public class StringSampleProgram1
{
	public static void main (String[] args)
	{
		...
		String str5=" ";
		System.out.println("str5 is empty or not: "+str5.isEmpty()); //space availability so yes its not empty

		String str6=new String();
		String str7="";
		System.out.println("str6 is empty or not: "+str6.isEmpty()); // there is no any string
		System.out.println("str6 is empty or not: "+str7.isEmpty());
