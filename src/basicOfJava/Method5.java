...
public class Method5 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Get interest using getInterest1(): "+Method5.getInterest1(250, 6.5, 60));
	...
	public static double getInterest(int p,double r,int t) {//p=250000, r=6.5, t=60
		return (p*r*t)/100;
			...
			//or
	public static double getInterest1(int p,double r,int t) {//p=250, r=6.5, t=60
