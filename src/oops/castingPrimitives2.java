package oops;
public class castingPrimitives2 {

	public static void main(String[] args) {		
		int salary=30000;
		/* explicit widening*/
		double salaryDouble=(double)salary; // we can store the value of int into the double
		...
		/*explicit narrowing*/
		int salaryInt=(int)salaryDb; // we cant store the value of double into int in reality we can store but lost chancces is maximum
