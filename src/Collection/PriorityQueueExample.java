...
public class PriorityQueueExample {
	...
	public static void main(String args[]) {
		...
		System.out.println("Eleements of Queue: " + queue); //direct in sort order
		...
		System.out.println("head element of the queue using element():" + queue.element()); // lower digit
		// peek() returns top most element of the queue, if the queue if empty dn it
		// will return 'null' instead of throwing exception
		System.out.println("head element of the queue using peek():" + queue.peek()); //startup number series in order
