...
class ThisKeyword6 {
	...
	void method(int variable) {
		...
		this.variable=variable; //this 51=10 tujhe 51 global ahet te equal to 10 jhale
		System.out.println("Value of Local variable :" + variable);//10
	...
	void method() {
		...
		this.variable=variable; // this 10 = 40 mhanje tujhe 10 je global hote te 40 jhale
		System.out.println("Value of Local variable :" + variable);//40
