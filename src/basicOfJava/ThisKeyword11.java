...
// VIMP 
//when the this keyword is use in left side 
// that means the local variable ki
//value global variable ko diyi ja rahi hai 

//when this keyword use in the right side that means the 
//global ki value local ko diyi ja rhi hai